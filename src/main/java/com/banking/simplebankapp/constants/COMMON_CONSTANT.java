package com.banking.simplebankapp.constants;
...
public class COMMON_CONSTANT {
    ...
    public static final String DEPOSIT_FAILED =
            "Fund deposit failed. Please try again.";

    public static final String WITHDRAW_FAILED =
            "Fund withdrawal failed. Please try again.";
}
